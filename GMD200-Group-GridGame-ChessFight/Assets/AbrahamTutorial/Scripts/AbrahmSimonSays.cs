...
public class AbrahmSimonSays : MonoBehaviour
{
    [SerializeField] private AbrahmGridManager _gridManager;
    ...
    private void OnTileSelected(AbrahmGridTile obj){
    ...
    private IEnumerator Co_PlayPattern(List<Vector2Int> positions){
        ...
        foreach(var pos in positions){
            ...
            AbrahmGridTile tile = _gridManager.GetTile(pos);
    ...
    private IEnumerator Co_FlashTile(AbrahmGridTile tile, Color color, float duration){
