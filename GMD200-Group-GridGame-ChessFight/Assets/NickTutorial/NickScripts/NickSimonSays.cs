...
public class NickSimonSays : MonoBehaviour
{
    ...
    private IEnumerator Co_PlayPattern(List<Vector2Int> positions) 
    {
        ...
        {
            NickGridTile tile = _gridManager.GetTile(pos);
    ...
    private IEnumerator Co_FlashTile(NickGridTile tile, Color color, float duration) 
    { 
        tile.setColor(color);
